...
struct gpio_dvs_t exynos5422_secgpio_dvs = {
	.result = &gpiomap_result,
	.check_gpio_status = check_gpio_status,
	.get_nr_gpio = exynos5422_secgpio_get_nr_gpio,
};

struct gpio_dvs_t exynos5430_secgpio_dvs = {
	.result = &gpiomap_result,
	.check_gpio_status = check_gpio_status,
	.get_nr_gpio = exynos5430_secgpio_get_nr_gpio,
};

struct gpio_dvs_t exynos5433_secgpio_dvs = {
	.result = &gpiomap_result,
	.check_gpio_status = check_gpio_status,
	.get_nr_gpio = exynos5433_secgpio_get_nr_gpio,
};

struct gpio_dvs_t exynos7420_secgpio_dvs = {
	.result = &gpiomap_result,
	.check_gpio_status = check_gpio_status,
	.get_nr_gpio = exynos7420_secgpio_get_nr_gpio,
};

struct gpio_dvs_t exynos7580_secgpio_dvs = {
	.result = &gpiomap_result,
	.check_gpio_status = check_gpio_status,
	.get_nr_gpio = exynos7580_secgpio_get_nr_gpio,
};
#endif
