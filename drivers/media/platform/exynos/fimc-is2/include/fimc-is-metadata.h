...
enum optical_stabilization_mode {
	...
	OPTICAL_STABILIZATION_MODE_VIDEO_RATIO_4_3, // Recording mode 4:3
};
...
struct camera2_aa_sm {
	...
	uint32_t	maxRegionsAwb; // TODO: [API32] not implemented yet
