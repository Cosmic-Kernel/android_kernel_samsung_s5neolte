...
#include "../vendor/fimc-is-vendor-config_j7.h"
#elif defined(CONFIG_CAMERA_GTA)
#include "../vendor/fimc-is-vendor-config_gta.h"
#elif defined(CONFIG_CAMERA_CARMEN2)
...
#elif defined(CONFIG_SOC_EXYNOS7420)
#define SUPPORTED_IS_CMD_VER	132
#define ENABLE_TMU_NOTIFIER
#define SUPPORTED_A5_MEMORY_SIZE_UP
#ifdef CONFIG_MACH_ESPRESSO7420
#undef SUPPORTED_A5_MEMORY_SIZE_UP
#if defined(CONFIG_ARM_EXYNOS7420_BUS_DEVFREQ)
#define CONFIG_FIMC_IS_BUS_DEVFREQ
#endif /* CONFIG_ARM_EXYNOS7420_BUS_DEVFREQ */
#endif

#elif defined(CONFIG_SOC_EXYNOS7580)
#define SUPPORTED_IS_CMD_VER	132
#define SUPPORTED_A5_MEMORY_SIZE_UP
#define ENABLE_FD_DMA_INPUT
#define FD_USE_SHARED_REGION
#undef ENABLE_CLOCK_GATE
#undef HAS_FW_CLOCK_GATE
#if defined(CONFIG_ARM_EXYNOS7580_BUS_DEVFREQ)
#define CONFIG_FIMC_IS_BUS_DEVFREQ
#endif /* CONFIG_ARM_EXYNOS7580_BUS_DEVFREQ */
#define USE_BTS_SCEN
