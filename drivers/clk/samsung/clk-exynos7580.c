...
enum exynos7580_clks {
	...
	ahb_usbhs, ahb2axi_usbhs, upsizer_fsys1, upsizer_ahb_usbhs, usbhost20,
	...
	/* ISP */
	/* DIV */
	dout_isp_pll_div2 = 2000, dout_isp_pll_div3, dout_sclk_cpu_isp_clkin,
	dout_sclk_cpu_isp_atclkin, dout_sclk_cpu_isp_pclkdbg, dout_pclk_csi_link0_225,
	dout_aclk_link_data = 2006, dout_aclk_csi_link1_75, dout_pclk_csi_link1_37,
	dout_aclk_fimc_isp_450, dout_pclk_fimc_isp_225, dout_aclk_fimc_fd_300,
	dout_pclk_fimc_fd_150 = 2012, dout_aclk_isp_266, dout_aclk_isp_133,
	dout_aclk_isp_67, dout_sclk_isp_spi0_ext_clk_a, dout_sclk_isp_spi0_ext_clk_b,
	dout_sclk_isp_spi1_ext_clk_a = 2018, dout_sclk_isp_spi1_ext_clk_b, dout_sclk_isp_uart_ext_uclk,
	dout_sclk_isp_sensor0_a, dout_sclk_isp_sensor0_b, dout_sclk_isp_sensor1_a,
	dout_sclk_isp_sensor1_b,

	/* MUX */
	mout_sclk_cpu_isp_clkin_a = 2025, mout_sclk_cpu_isp_clkin_b, mout_aclk_link_data_a,
	mout_aclk_link_data_b, mout_aclk_link_data_c, mout_aclk_csi_link1_75,
	mout_aclk_csi_link1_75_b = 2031, mout_aclk_fimc_isp_450_a, mout_aclk_fimc_isp_450_b,
	mout_aclk_fimc_isp_450_c, mout_aclk_fimc_isp_450_d, mout_aclk_fimc_fd_300,
	mout_sclk_isp_spi0_ext_clk= 2037, mout_sclk_isp_spi1_ext_clk, mout_sclk_isp_uart_ext_uclk,
	mout_sclk_isp_sensor0, mout_sclk_isp_sensor1,

	mout_aclk_isp_400_user = 2042, mout_aclk_isp_333_user, mout_aclk_isp_266_user,
	mout_sclk_spi0_isp_ext_clk_user, mout_sclk_spi1_isp_ext_clk_user, mout_sclk_uart_isp_ext_clk_user,
	mout_phyclk_csi_link0_rx_user, mout_phyclk_csi_link1_rx_user,

	/* TODO: Remove this */
	phyclk_csi_phy0_rxbyteclkhs0 = 2060,

	aclk_isp_1 = 2070,

	/* isp GATE clock */
	aclk_csi_link0_1_wrap_clk = 2100, aclk_csi_link1_1_wrap_clk,
	aclk_fimc_bns_aclk, aclk_fimc_bns_l_aclk,
	aclk_sasync_fimc_bns_m_to_bus, aclk_sasync_fimc_bns_l_to_bus,
	aclk_masync_fimc_bns_m_to_bus, aclk_masync_fimc_bns_l_to_bus,

	sclk_isp_sensor0 = 2110, sclk_isp_sensor1,
	/*
...
static struct samsung_composite_pll exynos7580_pll_clks[] = {
	...
	PLL(bus_pll, "bus_pll", pll_2551x, EXYNOS7580_BUS_PLL_LOCK,
	...
	PLL(isp_pll, "isp_pll", pll_2551x, EXYNOS7580_ISP_PLL_LOCK,
...
static struct samsung_composite_divider exynos7580_div_clks[] = {
	...
	/* ISP */
	DIV(dout_isp_pll_div2, "dout_isp_pll_div2", "isp_pll", \
			EXYNOS7580_DIV_ISP0, 0, 2, \
			EXYNOS7580_DIV_STAT_ISP0, 0, 1, 0, "dout_isp_pll_div2"),
	DIV(dout_isp_pll_div3, "dout_isp_pll_div3", "isp_pll", \
			EXYNOS7580_DIV_ISP0, 4, 2, \
			EXYNOS7580_DIV_STAT_ISP0, 4, 1, 0, "dout_isp_pll_div3"),
	DIV(dout_sclk_cpu_isp_clkin, "dout_sclk_cpu_isp_clkin", "mout_sclk_cpu_isp_clkin_b", \
			EXYNOS7580_DIV_ISP1, 0, 3, \
			EXYNOS7580_DIV_STAT_ISP1, 0, 1, 0, "dout_sclk_cpu_isp_clkin"),
	DIV(dout_sclk_cpu_isp_atclkin, "dout_sclk_cpu_isp_atclkin", "dout_sclk_cpu_isp_clkin", \
			EXYNOS7580_DIV_ISP1, 4, 3, \
			EXYNOS7580_DIV_STAT_ISP1, 4, 1, 0, "dout_sclk_cpu_isp_atclkin"),
	DIV(dout_sclk_cpu_isp_pclkdbg, "dout_sclk_cpu_isp_pclkdbg", "dout_sclk_cpu_isp_clkin", \
			EXYNOS7580_DIV_ISP1, 8, 3, \
			EXYNOS7580_DIV_STAT_ISP1, 8, 1, 0, "dout_sclk_cpu_isp_pclkdbg"),
	DIV(dout_pclk_csi_link0_225, "dout_pclk_csi_link0_225", "dout_isp_pll_div2", \
			EXYNOS7580_DIV_ISP2, 0, 2, \
			EXYNOS7580_DIV_STAT_ISP2, 0, 1, 0, "dout_pclk_csi_link0_225"),
	DIV(dout_aclk_link_data, "dout_aclk_link_data", "mout_aclk_link_data_c", \
			EXYNOS7580_DIV_ISP5, 0, 3, \
			EXYNOS7580_DIV_STAT_ISP5, 0, 1, 0, "dout_aclk_link_data"),
	DIV(dout_aclk_csi_link1_75, "dout_aclk_csi_link1_75", "mout_aclk_csi_link1_75_b", \
			EXYNOS7580_DIV_ISP2, 4, 3, \
			EXYNOS7580_DIV_STAT_ISP2, 4, 1, 0, "dout_aclk_csi_link1_75"),
	DIV(dout_pclk_csi_link1_37, "dout_pclk_csi_link1_37", "dout_aclk_csi_link1_75", \
			EXYNOS7580_DIV_ISP2, 8, 2, \
			EXYNOS7580_DIV_STAT_ISP2, 8, 1, 0, "dout_pclk_csi_link1_37"),
	DIV(dout_aclk_fimc_isp_450, "dout_aclk_fimc_isp_450", "mout_aclk_fimc_isp_450_d", \
			EXYNOS7580_DIV_ISP3, 0, 3, \
			EXYNOS7580_DIV_STAT_ISP3, 0, 1, 0, "dout_aclk_fimc_isp_450"),
	DIV(dout_pclk_fimc_isp_225, "dout_pclk_fimc_isp_225", "dout_aclk_fimc_isp_450", \
			EXYNOS7580_DIV_ISP3, 4, 3, \
			EXYNOS7580_DIV_STAT_ISP3, 4, 1, 0, "dout_pclk_fimc_isp_225"),
	DIV(dout_aclk_fimc_fd_300, "dout_aclk_fimc_fd_300", "mout_aclk_fimc_fd_300", \
			EXYNOS7580_DIV_ISP3, 8, 3, \
			EXYNOS7580_DIV_STAT_ISP3, 8, 1, 0, "dout_aclk_fimc_fd_300"),
	DIV(dout_pclk_fimc_fd_150, "dout_pclk_fimc_fd_150", "dout_aclk_fimc_fd_300", \
			EXYNOS7580_DIV_ISP3, 12, 2, \
			EXYNOS7580_DIV_STAT_ISP3, 12, 1, 0, "dout_pclk_fimc_fd_150"),
	DIV(dout_aclk_isp_266, "dout_aclk_isp_266", "mout_aclk_isp_266_user", \
			EXYNOS7580_DIV_ISP4, 0, 3, \
			EXYNOS7580_DIV_STAT_ISP4, 0, 1, 0, "dout_aclk_isp_266"),
	DIV(dout_aclk_isp_133, "dout_aclk_isp_133", "dout_aclk_isp_266", \
			EXYNOS7580_DIV_ISP4, 4, 2, \
			EXYNOS7580_DIV_STAT_ISP4, 4, 1, 0, "dout_aclk_isp_133"),
	DIV(dout_aclk_isp_67, "dout_aclk_isp_67", "dout_aclk_isp_266", \
			EXYNOS7580_DIV_ISP4, 8, 2, \
			EXYNOS7580_DIV_STAT_ISP4, 8, 1, 0, "dout_aclk_isp_67"),
	DIV(dout_sclk_isp_spi0_ext_clk_a, "dout_sclk_isp_spi0_ext_clk_a", "mout_sclk_isp_spi0_ext_clk", \
			EXYNOS7580_DIV_TOP_ISP0, 0, 4, \
			EXYNOS7580_DIV_STAT_TOP_ISP0, 0, 1, 0, NULL),
	DIV(dout_sclk_isp_spi0_ext_clk_b, "dout_sclk_isp_spi0_ext_clk_b", "dout_sclk_isp_spi0_ext_clk_a", \
			EXYNOS7580_DIV_TOP_ISP0, 4, 8, \
			EXYNOS7580_DIV_STAT_TOP_ISP0, 4, 1, 0, NULL),
	DIV(dout_sclk_isp_spi1_ext_clk_a, "dout_sclk_isp_spi1_ext_clk_a", "mout_sclk_isp_spi1_ext_clk", \
			EXYNOS7580_DIV_TOP_ISP0, 12, 4, \
			EXYNOS7580_DIV_STAT_TOP_ISP0, 12, 1, 0, NULL),
	DIV(dout_sclk_isp_spi1_ext_clk_b, "dout_sclk_isp_spi1_ext_clk_b", "dout_sclk_isp_spi1_ext_clk_a", \
			EXYNOS7580_DIV_TOP_ISP0, 16, 8, \
			EXYNOS7580_DIV_STAT_TOP_ISP0, 16, 1, 0, NULL),
	DIV(dout_sclk_isp_uart_ext_uclk, "dout_sclk_isp_uart_ext_uclk", "mout_sclk_isp_uart_ext_uclk", \
			EXYNOS7580_DIV_TOP_ISP0, 24, 4, \
			EXYNOS7580_DIV_STAT_TOP_ISP0, 24, 1, 0, NULL),
	DIV(dout_sclk_isp_sensor0_a, "dout_sclk_isp_sensor0_a", "mout_sclk_isp_sensor0", \
			EXYNOS7580_DIV_TOP_ISP1, 0, 4, \
			EXYNOS7580_DIV_STAT_TOP_ISP1, 0, 1, 0, NULL),
	DIV(dout_sclk_isp_sensor0_b, "dout_sclk_isp_sensor0_b", "dout_sclk_isp_sensor0_a", \
			EXYNOS7580_DIV_TOP_ISP1, 4, 4, \
			EXYNOS7580_DIV_STAT_TOP_ISP1, 4, 1, 0, NULL),
	DIV(dout_sclk_isp_sensor1_a, "dout_sclk_isp_sensor1_a", "mout_sclk_isp_sensor1", \
			EXYNOS7580_DIV_TOP_ISP1, 8, 4, \
			EXYNOS7580_DIV_STAT_TOP_ISP1, 8, 1, 0, NULL),
	DIV(dout_sclk_isp_sensor1_b, "dout_sclk_isp_sensor1_b", "dout_sclk_isp_sensor1_a", \
	...
	/* PERI */
	DIV(none, "dout_sclk_peri_aud", "mout_aud_pll_top_user", \
...
static struct samsung_usermux exynos7580_usermux_clks[] __initdata = {
	/* TOP */
	USERMUX(none, "mout_aud_pll_top_user", "aud_pll", \
			EXYNOS7580_MUX_SEL_TOP1, 0, \
			EXYNOS7580_MUX_STAT_TOP1, 0, 0, "mout_aud_pll_top_user"),
	...
	USERMUX(none, "mout_bus_pll_cpu_user", "bus_pll", \
			...
			EXYNOS7580_MUX_STAT_CPU_1, 0, CLK_IGNORE_UNUSED, "mout_bus_pll_cpu_user"),
	/* APL */
	USERMUX(none, "mout_bus_pll_apl_user", "bus_pll", \
			EXYNOS7580_MUX_SEL_APL_1, 0, \
			EXYNOS7580_MUX_STAT_APL_1, 0, CLK_IGNORE_UNUSED, "mout_bus_pll_apl_user"),
	/* ISP */
	USERMUX(mout_aclk_isp_400_user, "mout_aclk_isp_400_user", "aclk_isp_400", \
			EXYNOS7580_MUX_SEL_ISP1, 0, \
			EXYNOS7580_MUX_STAT_ISP1, 0, 0, "mout_aclk_isp_400_user"),
	USERMUX(mout_aclk_isp_333_user, "mout_aclk_isp_333_user", "aclk_isp_333", \
			EXYNOS7580_MUX_SEL_ISP1, 4, \
			EXYNOS7580_MUX_STAT_ISP1, 4, 0, "mout_aclk_isp_333_user"),
	USERMUX(mout_aclk_isp_266_user, "mout_aclk_isp_266_user", "aclk_isp_266", \
			EXYNOS7580_MUX_SEL_ISP1, 8, \
			EXYNOS7580_MUX_STAT_ISP1, 8, 0, "mout_aclk_isp_266_user"),
	USERMUX(mout_sclk_spi0_isp_ext_clk_user, "mout_sclk_spi0_isp_ext_clk_user", "sclk_isp_spi0_ext_clk", \
			EXYNOS7580_MUX_SEL_ISP1, 12, \
			EXYNOS7580_MUX_STAT_ISP1, 12, 0, "mout_sclk_spi0_isp_ext_clk_user"),
	USERMUX(mout_sclk_spi1_isp_ext_clk_user, "mout_sclk_spi1_isp_ext_clk_user", "sclk_isp_spi1_ext_clk", \
			EXYNOS7580_MUX_SEL_ISP1, 16, \
			EXYNOS7580_MUX_STAT_ISP1, 16, 0, "mout_sclk_spi1_isp_ext_clk_user"),
	USERMUX(mout_sclk_uart_isp_ext_clk_user, "mout_sclk_uart_isp_ext_clk_user", "sclk_isp_uart_ext_clk", \
			EXYNOS7580_MUX_SEL_ISP1, 20, \
			EXYNOS7580_MUX_STAT_ISP1, 20, 0, "mout_sclk_uart_isp_ext_clk_user"),
	USERMUX(mout_phyclk_csi_link0_rx_user, "mout_phyclk_csi_link0_rx_user", "phyclk_csi_phy0_rxbyteclkhs0", \
			EXYNOS7580_MUX_SEL_ISP2, 0, \
			EXYNOS7580_MUX_STAT_ISP2, 0, 0, "mout_phyclk_csi_link0_rx_user"),
	USERMUX(mout_phyclk_csi_link1_rx_user, "mout_phyclk_csi_link1_rx_user", "phyclk_csi_phy1_rxbyteclkhs0", \
	...
	/* FSYS */
	USERMUX(freeclk, "mout_phyclk_usbhost20_freeclk_user", "phyclk_usbhost20_freeclk", \
			EXYNOS7580_MUX_SEL_FSYS1, 8, \
			EXYNOS7580_MUX_STAT_FSYS1, 8, 0, "mout_phyclk_usb20_freeclk_user"),
	USERMUX(phyclk, "mout_phyclk_usbhost20_phyclock_user", "phyclk_usbhost20_phyclock", \
			EXYNOS7580_MUX_SEL_FSYS1, 12, \
			EXYNOS7580_MUX_STAT_FSYS1, 12, 0, "mout_phyclk_usb20_phyclock_user"),
	USERMUX(clk48mohci, "mout_phyclk_usbhost20_clk48mohcl_user", "phyclk_usbhost20_clk48mohcl", \
...
static struct samsung_gate exynos7580_gate_clks[] __initdata = {
	...
	GATE(none, "sclk_media_pll_top", "mout_media_pll_div2", \
			EXYNOS7580_EN_SCLK_TOP, 3, 0, NULL),
	...
	GATE(none, "aclk_qe_g3d", "dout_aclk_g3d_600", \
			EXYNOS7580_EN_ACLK_G3D, 5, CLK_IGNORE_UNUSED, "aclk_qe_g3d"),
	...
	GATE(none, "pclk_qe_g3d", "dout_pclk_g3d_150", \
			EXYNOS7580_EN_PCLK_G3D, 5, CLK_IGNORE_UNUSED, "pclk_qe_g3d"),
	GATE(none, "pclk_ppmu_g3d", "dout_pclk_g3d_150", \
			EXYNOS7580_EN_PCLK_G3D, 7, CLK_IGNORE_UNUSED, NULL),
	/* ISP */
	GATE(aclk_isp_1, "aclk_isp_1", "dout_aclk_fimc_isp_450", \
			EXYNOS7580_EN_ACLK_ISP_1, 26, 0, NULL),
	GATE(aclk_csi_link0_1_wrap_clk, "aclk_csi_link0_1_wrap_clk", "dout_isp_pll_div2", \
			EXYNOS7580_EN_ACLK_ISP_0, 0, 0, "aclk_csi_link0_1_wrap_clk"),
	GATE(aclk_fimc_bns_aclk, "aclk_fimc_bns_aclk", "dout_isp_pll_div2", \
			EXYNOS7580_EN_ACLK_ISP_0, 3, 0, "aclk_fimc_bns_aclk"),
	GATE(aclk_sasync_fimc_bns_m_to_bus, "aclk_sasync_fimc_bns_m_to_bus", "dout_isp_pll_div2", \
			EXYNOS7580_EN_ACLK_ISP_1, 27, 0, "aclk_sasync_fimc_bns_m_to_bus"),
	GATE(aclk_masync_fimc_bns_m_to_bus, "aclk_masync_fimc_bns_m_to_bus", "dout_aclk_link_data", \
			EXYNOS7580_EN_ACLK_ISP_1, 28, 0, "aclk_masync_fimc_bns_m_to_bus"),
	GATE(aclk_csi_link1_1_wrap_clk, "aclk_csi_link1_1_wrap_clk", "dout_aclk_csi_link1_75", \
			EXYNOS7580_EN_ACLK_ISP_0, 1, 0, "aclk_csi_link1_1_wrap_clk"),
	GATE(aclk_fimc_bns_l_aclk, "aclk_fimc_bns_l_aclk", "dout_aclk_csi_link1_75", \
			EXYNOS7580_EN_ACLK_ISP_0, 4, 0, "aclk_fimc_bns_l_aclk"),
	GATE(aclk_sasync_fimc_bns_l_to_bus, "aclk_sasync_fimc_bns_l_to_bus", "dout_aclk_csi_link1_75", \
			EXYNOS7580_EN_ACLK_ISP_1, 9, 0, "aclk_sasync_fimc_bns_l_to_bus"),
	GATE(aclk_masync_fimc_bns_l_to_bus, "aclk_masync_fimc_bns_l_to_bus", "dout_aclk_link_data", \
			EXYNOS7580_EN_ACLK_ISP_1, 2, 0, "aclk_masync_fimc_bns_l_to_bus"),
	/* DISP */
	...
	GATE(CLK_ACLK_DISP_200, "aclk_disp_200", "dout_aclk_disp_200", \
	...
	/* FSYS */
	GATE(pdma0, "aclk_dma_fsys0", "aclk_upsizer_dma_fsys0", \
			EXYNOS7580_EN_ACLK_FSYS0, 0, 0, NULL),
	GATE(pdma1, "aclk_dma_fsys1", "aclk_upsizer_dma_fsys1", \
			EXYNOS7580_EN_ACLK_FSYS0, 1, 0, NULL),
	GATE(usbhost20, "aclk_usbhost20", "aclk_fsys_200", \
			EXYNOS7580_EN_ACLK_FSYS0, 3, 0, NULL),
	GATE(none, "aclk_sromc_hclk", "aclk_fsys_200",
			EXYNOS7580_EN_ACLK_FSYS0, 6, 0, NULL),
	GATE(aclk_mmc0, "aclk_mmc0", "aclk_fsys_200",
			EXYNOS7580_EN_ACLK_FSYS0, 7, 0, NULL),
	GATE(aclk_mmc1, "aclk_mmc1", "aclk_fsys_200",
			EXYNOS7580_EN_ACLK_FSYS0, 8, 0, NULL),
	GATE(aclk_mmc2, "aclk_mmc2", "aclk_fsys_200",
			EXYNOS7580_EN_ACLK_FSYS0, 9, 0, NULL),
	GATE(otg_aclk, "aclk_usbotg20", "aclk_fsys_200", \
			EXYNOS7580_EN_ACLK_FSYS0, 16, 0, NULL),
	GATE(otg_hclk, "aclk_ahb2axi_usbotg", "aclk_fsys_200", \
			EXYNOS7580_EN_ACLK_FSYS0, 17, 0, NULL),
	GATE(upsizer_otg, "aclk_upsizer_usbotg", "aclk_fsys_200", \
			EXYNOS7580_EN_ACLK_FSYS0, 18, 0, NULL),
	GATE(xiu_d_fsys1, "aclk_xiu_d_fsys1", "aclk_fsys_200", \
			EXYNOS7580_EN_ACLK_FSYS1, 1, 0, NULL),
	...
	GATE(upsizer_fsys1, "aclk_upsizer_fsys1_to_fsys0", "aclk_fsys_200", \
			EXYNOS7580_EN_ACLK_FSYS2, 4, 0, NULL),
	GATE(none, "aclk_upsizer_dma_fsys0", "aclk_fsys_200", \
			EXYNOS7580_EN_ACLK_FSYS2, 6, 0, NULL),
	GATE(none, "aclk_upsizer_dma_fsys1", "aclk_fsys_200", \
			EXYNOS7580_EN_ACLK_FSYS2, 7, 0, NULL),
	GATE(upsizer_ahb_usbhs, "aclk_upsizer_ahb_usbhs", "aclk_fsys_200", \
			EXYNOS7580_EN_ACLK_FSYS2, 10, 0, NULL),
	GATE(none, "aclk_ppmu_fsys", "aclk_fsys_200", \
			EXYNOS7580_EN_ACLK_FSYS2, 11, 0, NULL),
	GATE(none, "pclk_ppmu_fsys", "aclk_fsys_200", \
			EXYNOS7580_EN_PCLK_FSYS, 18, 0, NULL),
	...
	GATE(usb_pll, "sclk_usb20_phy_clkcore", "usb_pll", \
			EXYNOS7580_EN_SCLK_FSYS, 1, 0, NULL),
	GATE(none, "phyclk_usbhot20_freeclk", "mout_phyclk_usbhost20_freeclk_user", \
			EXYNOS7580_EN_SCLK_FSYS, 14, CLK_IGNORE_UNUSED, NULL),
	GATE(none, "phyclk_usbhost20_usb20_phyclock", "mout_phyclk_usbhost20_phyclock_user", \
			EXYNOS7580_EN_SCLK_FSYS, 15, CLK_IGNORE_UNUSED, NULL),
	GATE(none, "phyclk_usbhost20_clk48mohci", "mout_phyclk_usbhost20_clk48mohcl_user", \
			EXYNOS7580_EN_SCLK_FSYS, 16, CLK_IGNORE_UNUSED, NULL),
	...
	GATE(none, "pclk_ppmu_imem", "aclk_imem_200", \
			EXYNOS7580_EN_PCLK_IMEM, 2, 0, NULL),
	...
	GATE(none, "aclk_ppmu_imem", "aclk_imem_266", \
			EXYNOS7580_EN_ACLK_IMEM, 10, 0, NULL),
	...
	GATE(puart0, "pclk_uart0", "dout_aclk_peri_66", \
			EXYNOS7580_EN_PCLK_PERIC, 15, 0, "console-pclk0"),
	...
	GATE(pclk_adcif, "pclk_adcif", "sclk_adcif_i_osc_sys", \
			EXYNOS7580_EN_PCLK_PERIC, 18, 0, NULL),
	...
	GATE(none, "sclk_peri_uart0_ext_uclk", "dout_sclk_peri_uart0", \
			EXYNOS7580_EN_SCLK_TOP_PERI, 7, 0, NULL),
	...
	GATE(none, "sclk_adcif_i_osc_sys", "dout_aclk_peri_66", \
			EXYNOS7580_EN_SCLK_PERIC, 17, 0, NULL),
	...
	GATE(puart3, "pclk_uart_aud", "dout_aclk_aud_133", \
	...
	GATE(suart3, "sclk_uart_aud", "dout_sclk_uart_aud", \
	...
	GATE(hsi2c0, "pclk_hsi2c0", "dout_aclk_peri_66", \
			EXYNOS7580_EN_PCLK_PERIC, 11, 0, NULL),
	GATE(hsi2c1, "pclk_hsi2c1", "dout_aclk_peri_66", \
			EXYNOS7580_EN_PCLK_PERIC, 12, 0, NULL),
	GATE(hsi2c2, "pclk_hsi2c2", "dout_aclk_peri_66", \
			EXYNOS7580_EN_PCLK_PERIC, 13, 0, NULL),
	...
	GATE(i2c0, "pclk_i2c0", "dout_aclk_peri_66", \
			EXYNOS7580_EN_PCLK_PERIC, 7, 0, NULL),
	GATE(none, "sclk_isp_spi0_ext_clk", "dout_sclk_isp_spi0_ext_clk_b", \
			EXYNOS7580_EN_SCLK_TOP_ISP, 0, 0, NULL),
	GATE(none, "sclk_isp_spi1_ext_clk", "dout_sclk_isp_spi1_ext_clk_b", \
			EXYNOS7580_EN_SCLK_TOP_ISP, 1, 0, NULL),
	GATE(none, "sclk_isp_uart_ext_clk", "dout_sclk_isp_uart_ext_uclk", \
			EXYNOS7580_EN_SCLK_TOP_ISP, 2, 0, NULL),
	GATE(sclk_isp_sensor0, "sclk_isp_sensor0", "dout_sclk_isp_sensor0_b", \
			EXYNOS7580_EN_SCLK_TOP_ISP, 3, 0, "sclk_isp_sensor0"),
	GATE(sclk_isp_sensor1, "sclk_isp_sensor1", "dout_sclk_isp_sensor1_b", \
			EXYNOS7580_EN_SCLK_TOP_ISP, 4, 0, "sclk_isp_sensor1"),
	/* MFCMSCL */
	GATE(GATE_ACLK_M2M_SCALER0, "aclk_m2m_scaler0", "aclk_xiu_d_mscl", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 0, 0, NULL),
	GATE(GATE_ACLK_M2M_SCALER1, "aclk_m2m_scaler1", "aclk_xiu_d_mscl", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 1, 0, NULL),
	GATE(CLK_ACLK_JPEG, "aclk_jpeg", "aclk_masync_ahb_jpeg", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 2, 0, NULL),
	GATE(none, "aclk_xiu_d_mscl", "aclk_bus_d_mscl", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 3, 0, NULL),
	GATE(none, "aclk_bus_d_mscl", "mout_aclk_mscl_400_user", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 4, 0, NULL),
	GATE(none, "aclk_masync_ahb_jpeg", "aclk_upsizer_xiu_d_mscl", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 5, 0, NULL),
	GATE(none, "aclk_upsizer_xiu_d_mscl", "aclk_xiu_d_mscl", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 6, 0, NULL),
	GATE(CLK_ACLK_SMMU_MSCL_MMU, "aclk_smmu_mscl_mmu", "mout_aclk_mscl_400_user", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 7, 0, NULL),
	GATE(none, "aclk_ppmu_mscl", "mout_aclk_mscl_400_user", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 8, 0, NULL),
	GATE(CLK_ACLK_AHB2APB_MFC, "aclk_ahb2apb_mfc", "dout_pclk_mfcmscl_100", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 9, 0, NULL),
	GATE(none, "aclk_sasync_ahb_jpeg", "dout_pclk_mfcmscl_100", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 12, 0, NULL),
	GATE(CLK_PCLK_AHB_JPEG, "pclk_ahb_jpeg", "aclk_sasync_ahb_jpeg", \
			EXYNOS7580_EN_PCLK_MFCMSCL, 0, 0, NULL),
	GATE(GATE_PCLK_M2M_SCALER0, "pclk_m2m_scaler0", "dout_pclk_mfcmscl_100", \
			EXYNOS7580_EN_PCLK_MFCMSCL, 1, 0, NULL),
	GATE(GATE_PCLK_M2M_SCALER1, "pclk_m2m_scaler1", "dout_pclk_mfcmscl_100", \
			EXYNOS7580_EN_PCLK_MFCMSCL, 2, 0, NULL),
	GATE(CLK_PCLK_SMMU_MSCL_MMU, "pclk_smmu_mscl_mmu", "dout_pclk_mfcmscl_100", \
			EXYNOS7580_EN_PCLK_MFCMSCL, 5, 0, NULL),
	GATE(none, "pclk_ppmu_mscl", "dout_pclk_mfcmscl_100", \
			EXYNOS7580_EN_PCLK_MFCMSCL, 6, 0, NULL),
	GATE(CLK_PCLK_SMMU_MFC_MMU, "pclk_smmu_mfc_mmu", "dout_pclk_mfcmscl_100", \
			EXYNOS7580_EN_PCLK_MFCMSCL, 17, 0, NULL),
	GATE(none, "pclk_ppmu_mfc", "dout_pclk_mfcmscl_100", \
			EXYNOS7580_EN_PCLK_MFCMSCL, 18, 0, NULL),
	GATE(CLK_PCLK_SASYNC_AHB2APB_MFC, "pclk_sasync_ahb2apb_mfc", "dout_pclk_mfcmscl_100", \
			EXYNOS7580_EN_PCLK_MFCMSCL, 19, 0, NULL),
	GATE(CLK_ACLK_MFC, "aclk_mfc", "mout_aclk_mfc_266_user", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 16, 0, NULL),
	GATE(CLK_PCLK_MFC, "pclk_mfc", "mout_aclk_mfc_266_user", \
			EXYNOS7580_EN_PCLK_MFCMSCL, 16, 0, NULL),
	GATE(CLK_ACLK_BUS_D_MFC, "aclk_bus_d_mfc", "mout_aclk_mfc_266_user", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 17, 0, NULL),
	GATE(CLK_ACLK_UPSIZER_MFC, "aclk_upsizer_mfc", "mout_aclk_mfc_266_user", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 18, 0, NULL),
	GATE(CLK_ACLK_SMMU_MFC_MMU, "aclk_smmu_mfc_mmu", "mout_aclk_mfc_266_user", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 19, 0, NULL),
	GATE(none, "aclk_ppmu_mfc", "mout_aclk_mfc_266_user", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 20, 0, NULL),
	GATE(CLK_ACLK_SASYNC_AHB2APB_MFC, "aclk_sasync_ahb2apb_mfc", "mout_aclk_mfc_266_user", \
			EXYNOS7580_EN_ACLK_MFCMSCL, 13, 0, NULL),
};
